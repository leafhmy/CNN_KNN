...
parser.add_argument('-data_dir', metavar='DIR', default='/home/st003/hmy/dataset/BloodCellSigned/segmentation_datasets/images/',
...
def main():
    ...
    loader = WBCDataset(args, simclr=True)
